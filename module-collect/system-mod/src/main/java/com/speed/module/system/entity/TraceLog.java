...
public class TraceLog extends IdEntity {
    ...
    @Column(columnDefinition = "bit(1) comment '是否成功'")
    ...
    @Column(columnDefinition = "varchar(2048) comment '结果'")
    @ApiModelProperty(value = "结果")
    private String resultContent;

    @Column(columnDefinition = "varchar(2048) comment '异常'")
    ...
    @Column(columnDefinition = "int(11) comment '持续时长'")
