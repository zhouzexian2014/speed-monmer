...
public class ProjectInfo extends BaseEntity {
    ...
    @Column(nullable = false,columnDefinition = "varchar(64) comment '项目编号'")
    @ApiModelProperty(value = "项目编号")
    private String projectNo;

    @Column(nullable = true,columnDefinition = "varchar(1024) comment '项目描述'")
    @ApiModelProperty(value = "项目描述")
    private String projectDesc;

    @Column(nullable = true,columnDefinition = "varchar(64) comment '项目负责人'")
    @ApiModelProperty(value = "项目负责人")
    private String projectLeader;

    @Column(nullable = true,columnDefinition = "int(3) comment '项目进度'")
    ...
    @Column(nullable = false,columnDefinition = "int(2) comment '项目状态'")
    @ApiModelProperty(value = "项目状态")
    private Integer projectStatus;

    @Column(nullable = false,columnDefinition = "bit(1) comment '是否模板'")
